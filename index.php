...
<head>
    ...
    <meta name="description" content="I am a PHP Developer with more than 3 years of experience working with PHP, 
                    i am experienced with both Procedural and OOP and I also work Laravel both for web development and API.
                                                My development experience cut across different sectors of economic such as education, agriculture,
                                                finances, insurance, technology and others">
    <!-- Favicons-->
        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-lg-8 home-content text-center">
                    <h1 class="home-name">Thomas <br> <span>Onyemechi</span></h1>
                    <h3 class="cd-headline clip home-headline">I’m a <span class="cd-words-wrapper single-headline"><b class="is-visible">Developer</b><b>Freelancer</b></span></h3>
                </div>
            </div>
        </div>
        <div class="fixed-wrapper">
            ...
            <div class="fixed-block block-left">
                <ul class="list-unstyled languages-list">
                    <li><a href="javascript:;"><span class="single-language">GIDEON</span></a></li>
                </ul>
            </div>
            <!-- Social media icons-->
            <div class="fixed-block block-right">
                <ul class="list-unstyled social-icons">
                    <li><a target="_blank" href="https://twitter.com/GideonOnyemechi"><i class="icon ion-logo-twitter"></i></a></li>
                    <li><a target="_blank" href="https://web.facebook.com/onyemechigideon.thomas"><i class="icon ion-logo-facebook"></i></a></li>
                    <li><a target="_blank" href="https://www.linkedin.com/in/thomas-onyemechi-201a0b1b1/"><i class="icon ion-logo-linkedin"></i></a></li>
                    <li><a target="_blank" href="https://github.com/thomasonyemechi"><i class="icon ion-logo-github"></i></a></li>
                    <li><a target="_blank" href="https://www.instagram.com/onyemechigideon/"><i class="icon ion-logo-instagram"></i></a></li>
                </ul>
            </div>
        </div>
    </section>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-lg-7 info-content">
                                    <div class="content-block">
                                        ...
                                        <h6 class="content-title">I'm Thomas Onyemechi, a Website/Software Developer</h6>
                                        <div class="content-description">
                                            <p>I am a PHP Developer with more than 3 years of experience working with PHP,
                                                i am experienced with both Procedural and OOP and I also work Laravel both for web development and API.
                                                My development experience cut across different sectors of economic such as education, agriculture,
                                                finances, insurance, technology and others, currently i work with Livepetal Systems, Ondo State Nigeria
                                                .</p>
                                        </div>
                                        <address class="content-info">
                                            <div class="row">
                                                <div class="col-12 col-md-6 single-info"><span>Name:</span>
                                                    <p>Thomas Onyemechi Gideon</p>
                                                </div>
                                                <div class="col-12 col-md-6 single-info"><span>Email:</span>
                                                    <p><a href="mailto:emma@example.com">thomasonyemechi03@gmail.com</a></p>
                                                </div>
                                            </div>
                                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="single-service"><i class="icon service-icon ion-logo-wordpress"></i>
                                        <h6 class="service-title">Website Development</h6>
                                        <p class="service-description">I help simplify the process and deliver the best website you can get.</p>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="single-service"><i class="icon service-icon ion-md-cash"></i>
                                        <h6 class="service-title">Payment Integration</h6>
                                        <p class="service-description">Bring in secure payment gateways into you website.</p>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="single-service"><i class="icon service-icon ion-logo-css3"></i>
                                        <h6 class="service-title">Software Development</h6>
                                        <p class="service-description">Create management software for your business, schools and finances.</p>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="single-service"><i class="icon service-icon ion-md-images"></i>
                                        <h6 class="service-title">Coding Traning</h6>
                                        <p class="service-description">Accelerate your dream of becoming a world-class software developer..</p>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="single-service"><i class="icon service-icon ion-logo-ionic"></i>
                                        <h6 class="service-title">Customer Support</h6>
                                        <p class="service-description">I provide the best customer support before and after purchase .</p>
                                    </div>
                                </div>

                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="single-service"><i class="icon service-icon ion-ios-rocket"></i>
                                        <h6 class="service-title">Api Development</h6>
                                        <p class="service-description">Custom api development well matched to fit your most urgent business needs.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="single-review swiper-slide">
                                        <div class="review-header d-flex justify-content-between">
                                            <div class="review-client">
                                                <div class="media"><img class="img-fluid rounded-circle client-avatar" src="img/-3.jpg" alt="Client">
                                                    <div class="client-details">
                                                        <h6 class="client-name">Mr. Adeola Omotola</h6><span class="client-role">Software Engineer New Jersey, US</span>
                                                    </div>
                                                </div>
                ...
                <div class="col-12">
                    <div class="lightbox-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="col-block education">
                                        ...
                                        <div class="resume-item"><span class="item-arrow"></span>
                                            <h5 class="item-title">Remote Science & Geo Science Information System</h5><span class="item-details">Fedral University of Technology Akure / 2022 - Present</span>
                                            <p class="item-description">Currrently Studying Remote Science & Geo Science Information System in the Fedral University of Technology.</p>
                                        </div>
                                        <div class="resume-item"><span class="item-arrow"></span>
                                            <h5 class="item-title"></h5><span class="item-details">High School Education / 2011 - 2019</span>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="col-block experience">
                                        ...
                                        <div class="resume-item"><span class="item-arrow"></span>
                                            <h5 class="item-title">Software Engineer</h5><span class="item-details">Livepetal Systems / 2020 - Present</span>
                                            <p class="item-description">Development of web application for loan, savings and investment management | Manage subscribers website. </p>
                                        </div>
                                        <div class="resume-item"><span class="item-arrow"></span>
                                            <h5 class="item-title">Back-End Developer</h5><span class="item-details">Illuminate / Dec 2020 - 2021</span>
                                            <p class="item-description">API development for school management with laravel | Using SQL for database manipulation</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="skills-section single-section">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="single-skill" data-percentage="100">
                                    ...
                                    <div class="single-skill" data-percentage="100">
                                        <div class="skill-info"><span class="skill-name">JavaScript / JQuery</span><span class="skill-percentage"></span></div>
                                        <div class="progress skill-progress">
                                            <div class="progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="single-skill" data-percentage="100">
                                        <div class="skill-info"><span class="skill-name">Laravel</span><span class="skill-percentage"></span></div>
                                        <div class="progress skill-progress">
                                            <div class="progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="single-skill" data-percentage="100">
                                        <div class="skill-info"><span class="skill-name">Api</span><span class="skill-percentage"></span></div>
                                        <div class="progress skill-progress">
                                            <div class="progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                        ...
                        <div class="video-section single-section">
                            <div class="row align-items-center">
                                <div class="col-12 col-lg-6 content-part">
                                    <h3 class="video-title">Fun Fact About Me</h3>
                                    <p class="video-description">
                                        I'm an experienced software engineer with a demonstrated history of developing an innovative web application that expedite the eﬃciency and eﬀectiveness of organizational success
                                    </p>
                                    <p class="video-description">
                                        Also, I am a Certified PHP Developer and i also have good experience of MySQL for database, HTML, CSS, JavaScript, React Js for frontend</p>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-5">
                                    <div class="contact-info">
                                        ...
                                        <p class="info-description">Always available for work if the right project comes along, Feel free to contact me!</p>
                                            ...
                                            <li>
                                                <div class="media align-items-center"><span class="info-icon"><i class="icon ion-logo-ionic"></i></span>
                                                    <div class="media-body info-details">
                                                        <h6 class="info-type">Name</h6><span class="info-value">Thomas Onyemechi</span>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="media align-items-center"><span class="info-icon"><i class="icon ion-md-map"></i></span>
                                                    <div class="media-body info-details">
                                                        <h6 class="info-type">Location</h6><span class="info-value">Federal Univeristy of Technology Akure, Nigeria.</span>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="media align-items-center"><span class="info-icon"><i class="icon ion-md-call"></i></span>
                                                    <div class="media-body info-details">
                                                        <h6 class="info-type">Call Me</h6><span class="info-value"><a href="tel:+2349038772366">+234 903 8772 366</a></span>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="media align-items-center"><span class="info-icon"><i class="icon ion-md-send"></i></span>
                                                    <div class="media-body info-details">
                                                        <h6 class="info-type">Email Me</h6><span class="info-value"><a href="mailto:thomasonyemechi03@gmail.com">thomasonyemechi03@gmail.com</a></span>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
